...
function lotocards() {
    ...
    document.getElementById("userbottomnum").innerHTML = usercardoutput;

    var dealercard = Math.floor(Math.random() * 13 + 2);

document.getElementById("dealerbottomnum").innerHTML = dealerbottomnum;
    ...
    document.getElementById("dealerbottomnum").innerHTML = dealercardoutput;
    ...
    switch(dealerchar) {
        case 1:
            ...
            document.getElementById("dealerBottomChar").style.color = "red";
        break;
        ...
        case 2:
            ...
            document.getElementById("dealerbigchar").style.color = "black";
             document.getElementById("dealerBottomChar").style.color = "black";
        break;
    ...
    document.getElementById("dealerBottomChar").innerHTML = dealerchar;
    ...
    switch(userchar) {
        case 1:
            ...
            document.getElementById("userBottomChar").style.color = "red";
        break;
        ...
        case 2:
            ...
            document.getElementById("userbigchar").style.color = "black";
             document.getElementById("userBottomChar").style.color = "black";
        break;
    ...
    document.getElementById("userBottomChar").innerHTML = userchar;
